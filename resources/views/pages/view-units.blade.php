...
@section('content')
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="container-xxl" id="kt_content_container">
            ...
            <div class="card">
                <!--begin::Card header-->
                <h1 class="fs-2hx fw-bold text-gray-800 me-2 lh-1 pl-2" style="padding: 10px"> Units </h1>
                            ...
                            <div class="modal-dialog modal-dialog-centered mw-650px">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header" id="kt_modal_add_user_header">
                                        <!--begin::Modal title-->
                                        <h2 class="fw-bolder">Add Unit</h2>
                                        ...
                                        <form id="kt_modal_add_user_form" class="form" method="POST"
                                            ...
                                            <div class="d-flex flex-column scroll-y me-n7 pe-7"
                                                ...
                                                <div class="fv-row mb-7">
                                                    ...
                                                    <input type="text" name="unit_division"
                                                        class="form-control form-control-solid mb-3 mb-lg-0"
                                                        placeholder="Unit Division" />
                                                </div>
                                                <div class="fv-row mb-7">
                                                    <label class="required fw-bold fs-6 mb-2">Unit Location</label>
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                        <thead>
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px">Unit Name</th>
                                <th class="min-w-125px">Unit Division</th>
                                <th class="min-w-125px">Location</th>
                                <th class="min-w-125px">Code</th>
                                <th class="min-w-25px">Date Added</th>
                                @if(auth()->user()->role == 'admin') <th class="text-end min-w-10px">Actions</th> @endif
                            </tr>
                        </thead>
                                        ...
                                        <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                            <a href="#">
                                                <div class="symbol-label fs-3 bg-light-danger text-danger">
                                                    {{ strtoupper(mb_substr($unit->name, 0, 1)) }}
                                                </div>
                                            </a>
                                        </div>
                                    </td>
                                    <td class="">
                                        <span>{{ ucfirst($unit->name) }}</span>
                                    </td>
                                    <td class="">
                                        <span>{{ ucfirst($unit->div) }}</span>
                                    </td>
                                    <td class="">
                                        <span>{{ ucfirst($unit->location) }}</span>
                                    </td>
                                    <td class="">
                                        <span>{{ $unit->code }} </span>
                                    </td>
                                    ...
                                    @if(auth()->user()->role == 'admin')
                                        <td class="text-end">
                                            <div class="menu-item px-3">
                                                <a href="/api/delete-unit/{{ encrypt_data($unit->id) }}"
