@php
    $vendors = \App\Models\Vendor::orderBy('created_at', 'DESC')->get();
    $units = \App\Models\Unit::orderBy('created_at', 'DESC')->get();
    $officers = \App\Models\User::where('role', 'manager')
                                    ...
                                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                        ...
                                        <form id="kt_modal_add_user_form" class="form" method="POST"
                                            ...
                                            <div class="d-flex flex-column scroll-y me-n7 pe-7"
                                                ...
                                                <div class="fv-row mb-7">
                                                    <label class="required fw-bold fs-6 mb-2">Vendor Email</label>
                                                    <input type="email" name="vendor_email"
                                                        class="form-control form-control-solid mb-3 mb-lg-0"
                                                        placeholder="Vendor Email" />
                                                </div>
                                                <div class="fv-row mb-7">
                                                    <label class="required fw-bold fs-6 mb-2">Vendor Phone</label>
                                                    <input type="text" name="vendor_phone"
                                                        class="form-control form-control-solid mb-3 mb-lg-0"
                                                        placeholder="Vendor Phone" />
                                                </div>
                                                <div class="fv-row mb-7">
                                                    <label class="required fw-bold fs-6 mb-2">Vendor Address</label>
                                                    <textarea name="vendor_address" placeholder="Vendor Address" class="form-control form-control-solid mb-3 mb-lg-0"
                        ...
                        <tbody class="text-gray-600 fw-bold">
                            @foreach ($vendors as $key => $vendor)
                                <tr>
                                        ...
                                        <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                            <a href="#">
                                                <div class="symbol-label fs-3 bg-light-danger text-danger">
                                                    {{ strtoupper(mb_substr($vendor->name, 0, 1)) }}
                                                </div>
                                            </a>
                                        </div>
                                    </td>
                                    <td class="">
                                        <span>{{ ucfirst($vendor->name) }}</span>
                                    </td>
                                    <td class="">
                                    ...
                                    <td class="">
                                        <span>{{ ucfirst($vendor->address) }}</span>
                                    </td>
                                    <td class="">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                            ...
                                            @if (auth()->user()->role == 'admin')
                                                <div class="menu-item px-3">
                                                    <a href="/api/delete-vendor/{{ encrypt_data($vendor->id) }}"
