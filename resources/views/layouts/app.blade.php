            ...
            <div class="card-body" id="kt_help_body">
                ...
                <div id="kt_help_scroll" class="hover-scroll-overlay-y" data-kt-scroll="true"
                    ...
                    <div class="rounded border border-dashed border-gray-300 p-6 p-lg-8 mb-10">
                        <!--begin::Heading-->
                        <h2 class="fw-bolder mb-5">Support at <a href="https://devs.keenthemes.com/"
                    ...
                    <div class="d-flex align-items-center mb-7">
                        ...
                        <div
                            ...
                            <span class="svg-icon svg-icon-warning svg-icon-2x svg-icon-lg-3x"><svg
                        ...
                        <div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
                            ...
                            <span class="svg-icon svg-icon-gray-400 svg-icon-2"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none">
                    ...
                    <div class="d-flex align-items-center mb-7">
                        ...
                        <div
                            ...
                            <span class="svg-icon svg-icon-primary svg-icon-2x svg-icon-lg-3x"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none">
                                    <path
                    ...
                    <div class="d-flex align-items-center mb-7">
                        ...
                        <div
                            ...
                            <span class="svg-icon svg-icon-info svg-icon-2x svg-icon-lg-3x"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none">
                                    <path opacity="0.3"
                    ...
                    <div class="d-flex align-items-center mb-7">
                        ...
                        <div
                            ...
                            <span class="svg-icon svg-icon-danger svg-icon-2x svg-icon-lg-3x"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none">
                                    <path
