            ...
            <div id="kt_aside" class="aside aside-extended bg-white " data-kt-drawer="true" data-kt-drawer-name="aside"
                ...
                <div class="aside-primary d-flex flex-column align-items-lg-center flex-row-auto">
                    ...
                    <div class="aside-logo d-none d-lg-flex flex-column align-items-center flex-column-auto pt-10"
                        id="kt_aside_logo">
                        <a href="/dashboard">
                            <img alt="Logo" src="{{ asset('assets/media/logos/logo.png') }}" class="h-55px" />
                        </a>
                    </div>
                    <!--end::Logo-->
                        ...
                        <div class="w-100 hover-scroll-overlay-y d-flex" id="kt_aside_menu_wrapper"
                            ...
                            <div id="kt_aside_menu"
                                ...
                                @if(auth()->user()->role == 'admin')
                                    <div class="menu-item py-2">
                                        <a class="menu-link menu-center  @if(request()->path() == 'view-admins') active @endif" href="/view-admins" title="View admins" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                                            <span class="menu-icon me-0">
                                                <span class="svg-icon svg-icon-2x">
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                <div class="menu-item py-2">
                                    <a class="menu-link menu-center @if(request()->path() == 'view-categories') active @endif" href="/view-categories" title="Categories" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                                        <span class="menu-icon me-0">
                                            <span class="svg-icon svg-icon-2x">
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    width="24" height="24" viewBox="0 0 24 24" fill="none">
